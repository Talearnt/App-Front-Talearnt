  ...
  Widget build(BuildContext context) {
    ...
    return Column(
        ...
        children: <Widget>[
          ...
          const SizedBox(height: 16),
          Wrap(
            children: setKeywordProvider.interestTalentKeywordCodes.map((item) {
              String labelText = '';
              for (var category in GlobalValueConstants.keywordCategoris) {
                if (category.talentKeywords
                    .any((talent) => talent.code == item)) {
              ...
              return Padding(
                ...
                child: ChoiceChip(
                  ...
                  label: Text(labelText),
                  labelStyle: TextStyle(
                    color: setKeywordProvider.selectedInterestTalentKeywordCodes
                            .map((keyword) => keyword)
                            .contains(item)
                        ? Palette.primary01
                        : Palette.text04,
                  ...
                  onSelected: (selected) {
                    ...
                    setKeywordProvider.updateSelectedInterestTalentKeywordCodes
                        .call(updatedFilter);
                  },
                ),
              );
