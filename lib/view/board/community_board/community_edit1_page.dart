...
class CommunityEdit1Page extends StatelessWidget {
  const CommunityEdit1Page({super.key});
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                communityEditProvider.categoryRequiredMessage,
                              ...
                              ...GlobalValueConstants.communityCategoryTypes
                                ...
                                return ChoiceChip(
                                  ...
                                  onSelected: (selected) {
                                    final updatedFilter =
                                        communityEditProvider.selectedCategory;
                                    updatedFilter == labelText
                                        ? communityEditProvider
                                            .removeSelectedCategory()
                                        : communityEditProvider
                                            .updateSelectedCategory(labelText);
                                  },
                                );
                              }).toList(),
                            ],
